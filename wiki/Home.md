...
| --- | --- |
| [Overview](#overview) | What the plugin does |
| [Architecture](#architecture) | How the Dart ↔ native bridge is wired |
| [Project Structure](#project-structure) | Directory layout |
| [Public API](#public-api) | Every method with examples |
| [MethodChannel Contract](#methodchannel-contract) | Channel/method/argument names |
| [Platform Behavior](#platform-behavior) | Android & iOS specifics |
| [Secrets & Configuration](#secrets--configuration) | `.secrets/zendesk.env` wiring |
| [Error Handling](#error-handling) | `ZendeskSdkException` & error codes |
| [Setup & Installation](#setup--installation) | Adding the dependency |
